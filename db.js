...
export const DB = (function () {
  ...
  return {
    ...
    async exportAll() {
      ...
      const [stocks, snapshots, monthly, meta, feed, funds, fds, dividends, metals, bonds, emergency, bankSavings, creditCards, allocations, ccReimbursements] = await Promise.all([
        this.all('stocks'),
        this.all('snapshots'),
        this.all('monthly'),
        this.all('meta'),
