...
Every code change bumps `CACHE = 'mynote-stocks-vNN'` in `service-worker.js`. Current version after the MF units/NAV-derived value + Benchmark-tab (Below/Within/Above) update: **v72**. The next change should be v73.
