...
Every code change bumps `CACHE = 'mynote-stocks-vNN'` in `service-worker.js`. Current version at the time of writing this doc set: **v46**. The next change should be v47.
